...
export default class extends Extension {
    async search(kw, page) {
        ...
        bsxList.forEach((element) => {
            ...
            const cover = cover_match ? element.match(/data-original="(.+?)"/)[1] : "https://gimy.is" + element.match(/data-original="(.+?)"/)[1];
            bangumi.push({
                title,
                url: url,
                cover,
    ...
    async detail(url) {
        ...
        const cover = patrial_cover_url.match(/https/)?patrial_cover_url:"https://gimy.is"+patrial_cover_url;
